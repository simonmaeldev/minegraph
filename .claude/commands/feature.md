---
allowed-tools: Read, Write, Edit, Glob, Grep, Bash(wget:), Bash(curl:), WebFetch, WebSearch
description: Create a new plan to implement a feature.
argument-hint: [user prompt] [optional relevant files]
...
USER_PROMPT: $1
RELEVANT_FILES_COLLECTION: $2 or empty by default
